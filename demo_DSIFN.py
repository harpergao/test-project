...
def get_args():
    ...
    parser.add_argument('--project_name', default='chck', type=str)
    parser.add_argument('--gpu_ids', type=str, default='0', help='gpu ids: e.g. 0  0,1,2, 0,2. use -1 for CPU')
    parser.add_argument('--checkpoint_root', default='/home/gyf/newtest/ChangeFormer/checkpoint/ChangeFormer_LEVIR', type=str)
