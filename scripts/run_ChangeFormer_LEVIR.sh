...
#Set paths
checkpoint_root=/data/gyf/newtest/ChangeFormer/checkpoint3/base_transformer_pos_s4_dd8_5
vis_root=/data/gyf/newtest/ChangeFormer/vis3/base_transformer_pos_s4_dd8_5        #Sets the root directory where visual outputs, like images of the detected changes, will be saved.
data_name=LEVIR
...
net_G=baseline_res       #ChangeFormerV6 is the finalized verion
